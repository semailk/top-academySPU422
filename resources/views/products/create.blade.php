...
{{--                               <div class="mb-4">
                        ...
                        @enderror
                    </div> class="w-full bg-gray-800 text-white border border-gray-700 rounded-lg px-4 py-2 focus:outline-none focus:border-blue-500 @error('name') border-red-500 @enderror"--}}
{{--                               required>--}}
{{--                        @error('name')--}}
{{--                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>--}}
{{--                        @enderror--}}
